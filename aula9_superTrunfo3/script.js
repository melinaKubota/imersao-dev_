...
function sortearCarta() {
    var numeroCartaMaquina = parseInt(Math.random() * cartas.length) //cartas.length vai dar o número de cartas que temos e não um número fixo
    cartaMaquina = cartas[numeroCartaMaquina]
    cartas.splice(numeroCartaMaquina, 1)// o número é de quantos elementos a gente quer que retire
